...
public class Game extends Activity {
	...
	private com.example.sudoku.PuzzleView puzzleView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		puzzleView = new com.example.sudoku.PuzzleView(this);
	...
	protected void showKeypadOrError(int x, int y) {
		...
		if (tiles.length == 9) {
			...
			Dialog v = new com.example.sudoku.Keypad(this, tiles, puzzleView);
			v.show();
		}
	}
